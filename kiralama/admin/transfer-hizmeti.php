...
include ("../database.php");
$id=(int)$_GET['id'];
$calistir = mysqli_query($db,("select * from transfer order by id DESC LIMIT 1") or die("Hata Olustu! ".mysql_error());
...
?>
	<div id="content">
		...
		<div id="main">		
			...
			<div class="h_title">Transfer Hizmeti</div>
	<form action="transfer-hizmeti-kaydediliyor.php" method="post">
		<p>
